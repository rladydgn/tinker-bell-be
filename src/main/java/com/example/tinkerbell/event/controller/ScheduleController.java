...
public class ScheduleController {
	...
	public ResponseEntity<Void> changeSchedule(@Login User user, @PathVariable int eventId, @PathVariable int scheduleId, @RequestBody ScheduleDto.Request request) {
	...
	public ResponseEntity<Void> removeSchedule(@Login User user, @PathVariable int eventId, @PathVariable int scheduleId) {
